...
export class AboutPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, 
    private userProvider: UserProvider, private toastController: ToastController) {
  ...
  updateProfile(){
    if(!this.model.username || !this.model.password || !this.model.position || 
      !this.model.phone || !this.model.email || !this.model.affiliation){
